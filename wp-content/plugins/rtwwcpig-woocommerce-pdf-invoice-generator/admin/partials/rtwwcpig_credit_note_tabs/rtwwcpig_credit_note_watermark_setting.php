...
if(!empty($rtwwcpig_purchase_code_details) && is_array($rtwwcpig_purchase_code_details) && !empty($rtwwcpig_purchase_code_details) && isset($rtwwcpig_purchase_code_details['status']) &&  $rtwwcpig_purchase_code_details['status'] == true && isset($rtwwcpig_purchase_code_details['purchase_code']) && $rtwwcpig_purchase_code_details['purchase_code'] != '' )
{
	...
	if(isset($_POST['rtwwcpig_submit'])) { ?>
		...
		woocommerce_update_options( rtwwcpig_creditnote_watermak_settings() );

		update_option( 'rtwwcpig_creditnote_watermark_setting_opt', sanitize_post($_POST['rtwwcpig_creditnote_watermark_setting_opt']) );

	}

	settings_fields('rtwwcpig_watermark_setting');
	$rtwwcpig_get_setting = get_option('rtwwcpig_creditnote_watermark_setting_opt'); 

	$rtwwcpig_wtrmrk_txt = get_option('rtwwcpig_enable_creditnote_text_watermark');
	$rtwwcpig_wtrmrk_img = get_option('rtwwcpig_enable_creditnote_image_watermark');
	$rtwwcpig_wtrmrk_img_dim = get_option('rtwwcpig_creditnote_watermark_img_dim');
	$rtwwcpig_wtrmrk_img_pos = get_option('rtwwcpig_creditnote_watermark_img_pos');

	?>

	<div class="rtwwcpig_tab_div">
		<?php woocommerce_admin_fields(rtwwcpig_creditnote_watermak_settings()); ?> 
	</div>

	<input type="hidden" id="credi_note_show_wtrmrk_txt" value="<?php echo esc_attr($rtwwcpig_wtrmrk_txt); ?>">
	<input type="hidden" id="credi_note_show_wtrmrk_img" value="<?php echo esc_attr($rtwwcpig_wtrmrk_img); ?>">
	<input type="hidden" id="credi_note_wtrmrk_img_dim" value="<?php echo esc_attr($rtwwcpig_wtrmrk_img_dim); ?>">
	<input type="hidden" id="credi_note_wtrmrk_img_pos" value="<?php echo esc_attr($rtwwcpig_wtrmrk_img_pos); ?>">
	<!-- Image watermark -->
	<table id="rtwwcpig_creditnote_add_watermark_img" class="wp-list-table form-table rtw-table">
		<tr>
			...
			<td>
				...
				<div id="rtwwcpig_wtrmrk_img" >
					...
					name="rtwwcpig_creditnote_watermark_setting_opt[rtwwcpig_watermark_img_url]"
...
* @since    1.0.0
*/
function rtwwcpig_creditnote_watermak_settings()
{
global $rtwwcpig_watermark_pos;
global $rtwwcpig_watermark_size_array ;
...
$settings =	array(
	'section_title' => array(
		...
		'type'     => 'title',
		'desc'     => '',
		'id'       => 'rtwwcpig_creditnote_watermark_setting_opt'
	),
	array(
		...
		'desc_tip' =>  true,
		'id'   		=> 'rtwwcpig_enable_creditnote_text_watermark',
		'class'    => 'rtwwcpig_credinote_wtrmrk'
	),
	array(
		'id'          => 'rtwwcpig_creditnote_watermark_font',
		'class'       => 'rtwwcpig_creditnote_text_add_watermark',
	...
	array(
		...
		'id'   		=> 'rtwwcpig_creditnote_watermark_text',
		'class'       => 'rtwwcpig_creditnote_text_add_watermark',
		'desc_tip' =>  true,
	),
	array(
		...
		'id'   		=> 'rtwwcpig_credit_watermark_text_trans',
		'class'       => 'rtwwcpig_creditnote_text_add_watermark',
		'default'	=> '0.1',
		'desc_tip' =>  true,
	),
	array(
		...
		'desc_tip' =>  true,
		'id'   		=> 'rtwwcpig_enable_creditnote_image_watermark',
		'class'    => 'rtwwcpig_creditnote_imgwtrmk'
	),
	array(
		...
		'id'   		=> 'rtwwcpig_creditnote_watermark_image_trans',
		'class'     => 'rtwwcpig_creditnote_add_watermark_image',
		'default'	=> '0.1',
		'desc_tip' =>  true,
	),
	array(
		'id'          => 'rtwwcpig_creditnote_watermark_img_dim',
		'option_key'  => 'rtwwcpig_creditnote_watermark_img_dim',
	...
	array(
		...
		'id'   		=> 'rtwwcpig_creditnote_water_img_dim_int',
		'class'     => 'rtwwcpig_creditnote_add_watermark_image_dimen_integer',
		'desc_tip' =>  true,
	),
	array(
		...
		'id'   		=> 'rtwwcpig_creditnote_water_img_dim_width',
		'class'     => 'rtwwcpig_creditnote_add_watermark_image_dimension',
		'desc_tip' =>  true,
	),
	array(
		...
		'id'   		=> 'rtwwcpig_creditnote_water_img_dim_height',
		'class'     => 'rtwwcpig_creditnote_add_watermark_image_dimension',
		'desc_tip' =>  true,
	),
	array(
		'id'          => 'rtwwcpig_creditnote_watermark_img_pos',
		'option_key'  => 'rtwwcpig_creditnote_watermark_img_pos',
		'name'       => esc_html__( 'Image Position', 'rtwwcpig-woocommerce-pdf-invoice-generator' ),
		'desc' => esc_html__( 'Choose the font family of Watermark text.', 'rtwwcpig-woocommerce-pdf-invoice-generator' ),
		'type'        => 'select',
		'class'       => 'rtwwcpig_creditnote_doc-add-watermark-image-pos-select',
	...
	array(
		...
		'id'   		=> 'rtwwcpig_creditnote_watermark_img_pos_y',
		'class'     => 'rtwwcpig_creditnote_add_watermark_image_pos',
		'desc_tip' =>  true,
	),
	array(
		...
		'id'   		=> 'rtwwcpig_creditnote_watermark_img_pos_x',
		'class'     => 'rtwwcpig_creditnote_add_watermark_image_pos',
		'desc_tip' =>  true,
	),
