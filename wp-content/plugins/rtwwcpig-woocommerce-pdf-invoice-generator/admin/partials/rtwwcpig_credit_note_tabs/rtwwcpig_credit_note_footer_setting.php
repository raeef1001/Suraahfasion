...
if(!empty($rtwwcpig_purchase_code_details) && is_array($rtwwcpig_purchase_code_details) && !empty($rtwwcpig_purchase_code_details) && isset($rtwwcpig_purchase_code_details['status']) &&  $rtwwcpig_purchase_code_details['status'] == true && isset($rtwwcpig_purchase_code_details['purchase_code']) && $rtwwcpig_purchase_code_details['purchase_code'] != '' )
{
	...
	if(isset($_POST['rtwwcpig_submit'])) {
		...
		<div class="notice notice-success is-dismissible">
			...
			update_option( 'rtwwcpig_credit_note_footer_setting_opt', sanitize_post($_POST['rtwwcpig_credit_note_footer_setting_opt']) );

			woocommerce_update_options( rtwwcpig_credit_note_footer_settings());
		}

		settings_fields('rtwwcpig_credit_note_footer_setting');
		$rtwwcpig_get_setting = get_option('rtwwcpig_credit_note_footer_setting_opt'); 
	?>

	<div class="rtwwcpig_tab_div">
		<?php woocommerce_admin_fields(rtwwcpig_credit_note_footer_settings()); ?> 
	</div>
			...
			<tr>
				...
				<td>
					...
					$rtwwcpig_setting = array(
						'wpautop' => true,
						'media_buttons' => true,
						'textarea_name' => 'rtwwcpig_credit_note_footer_setting_opt[rtw_footer_html]',
						'textarea_rows' => 7
					);
...
* @since    1.0.0
*/
function rtwwcpig_credit_note_footer_settings()
{
...
$settings =	array(
	'section_title' => array(
		...
		'type'     => 'title',
		'desc'     => '',
		'id'       => 'rtwwcpig_credit_note_footer_setting_optn'
	),
	array(
		...
		'id'   		=> 'rtwwcpig_credit_note_footer_top_margin',
		'default'   => '15',
		'desc_tip' =>  true,
	),
	array(
		...
		'id'   		=> 'rtwwcpig_credit_note_footer_font_size',
		'default'   => '15',
		'desc_tip' =>  true,
	),
	array(
		'id'          => 'rtwwcpig_credit_note_footer_font_family',
		'option_key'  => 'rtwwcpig_pckngslp_footer_font_family',
