...
if(!empty($rtwwcpig_purchase_code_details) && is_array($rtwwcpig_purchase_code_details) && !empty($rtwwcpig_purchase_code_details) && isset($rtwwcpig_purchase_code_details['status']) &&  $rtwwcpig_purchase_code_details['status'] == true && isset($rtwwcpig_purchase_code_details['purchase_code']) && $rtwwcpig_purchase_code_details['purchase_code'] != '' )
{
	...
	if(isset($_POST['rtwwcpig_submit'])) { ?>
		...
		woocommerce_update_options( rtwwcpig_shpng_lbl_watermak_settings() );

		update_option( 'rtwwcpig_shpng_lbl_watermark_setting_opt', sanitize_post($_POST['rtwwcpig_shpng_lbl_watermark_setting_opt']) );

	}

	settings_fields('rtwwcpig_watermark_setting');
	$rtwwcpig_get_setting = get_option('rtwwcpig_shpng_lbl_watermark_setting_opt'); 

	$rtwwcpig_wtrmrk_txt = get_option('rtwwcpig_enable_shpng_lbl_text_watermark');
	$rtwwcpig_wtrmrk_img = get_option('rtwwcpig_enable_shpng_lbl_image_watermark');
	$rtwwcpig_wtrmrk_img_dim = get_option('rtwwcpig_shpng_lbl_watermark_img_dim');
	$rtwwcpig_wtrmrk_img_pos = get_option('rtwwcpig_shpng_lbl_watermark_img_pos');

	?>

	<div class="rtwwcpig_tab_div">
		<?php woocommerce_admin_fields(rtwwcpig_shpng_lbl_watermak_settings()); ?> 
	</div>
		...
		<tr>
			...
			<td>
				...
				<div id="rtwwcpig_wtrmrk_img" >
					...
					name="rtwwcpig_shpng_lbl_watermark_setting_opt[rtwwcpig_watermark_img_url]"
 ...
 * @since    1.0.0
 */
function rtwwcpig_shpng_lbl_watermak_settings()
{
	global $rtwwcpig_watermark_pos;
	global $rtwwcpig_watermark_size_array ;
	...
	$settings =	array(
		'section_title' => array(
			...
			'type'     => 'title',
			'desc'     => '',
			'id'       => 'rtwwcpig_shpng_lbl_watermark_setting_opt'
		),
		array(
			...
			'desc_tip' =>  true,
			'id'   		=> 'rtwwcpig_enable_shpng_lbl_text_watermark',
			'class'    => 'rtwwcpig_pckngslp_wtrmrk'
		),
		array(
			'id'          => 'rtwwcpig_shpng_lbl_watermark_font',
		...
		array(
			...
			'id'   		=> 'rtwwcpig_shpng_lbl_watermark_rotation',
			'class'       => 'rtwwcpig_pckngslp_text_add_watermark',
			'default'	=> '15',
			'desc_tip' =>  true,
		),
		array(
			...
			'id'   		=> 'rtwwcpig_shpng_lbl_watermark_text',
			'class'       => 'rtwwcpig_pckngslp_text_add_watermark',
			'desc_tip' =>  true,
		),
		array(
			...
			'id'   		=> 'rtwwcpig_shpng_lbl_watermark_text_trans',
			'class'       => 'rtwwcpig_pckngslp_text_add_watermark',
			'default'	=> '0.1',
			'desc_tip' =>  true,
		),
		array(
			...
			'desc_tip' =>  true,
			'id'   		=> 'rtwwcpig_enable_shpng_lbl_image_watermark',
		...
		array(
			...
			'id'   		=> 'rtwwcpig_shpng_lbl_watermark_image_trans',
		...
		array(
			...
			'option_key'  => 'rtwwcpig_shpng_lbl_watermark_img_dim',
		...
		array(
			...
			'id'   		=> 'rtwwcpig_shpng_lbl_water_img_dim_int',
		...
		array(
			...
			'id'   		=> 'rtwwcpig_shpng_lbl_water_img_dim_width',
		...
		array(
			...
			'id'   		=> 'rtwwcpig_shpng_lbl_water_img_dim_height',
			'class'     => 'rtwwcpig_pckngslp_add_watermark_image_dimension',
			'desc_tip' =>  true,
		),
		array(
			'id'          => 'rtwwcpig_shpng_lbl_watermark_img_pos',
			'option_key'  => 'rtwwcpig_shpng_lbl_watermark_img_pos',
		...
		array(
			...
			'id'   		=> 'rtwwcpig_shpng_lbl_watermark_img_pos_y',
		...
		array(
			...
			'id'   		=> 'rtwwcpig_shpng_lbl_watermark_img_pos_x',
			'class'     => 'rtwwcpig_pckngslp_add_watermark_image_pos',
			'desc_tip' =>  true,
		),
